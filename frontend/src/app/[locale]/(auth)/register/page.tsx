    ...
    <div className="relative z-20">
     ...
     <div className="max-w-md mt-16 space-y-8">
      <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-sky-50/80 dark:bg-white/5 border border-sky-100 dark:border-white/10 backdrop-blur-md shadow-[0_0_15px_rgba(56,189,248,0.1)] dark:shadow-[0_0_15px_rgba(56,189,248,0.15)]">
        ...
        <span className="text-xs font-bold uppercase tracking-widest text-sky-700 dark:text-sky-100">Join the Network</span>
      </div>
      <h1 className="text-5xl lg:text-6xl font-heading font-extrabold leading-[1.1] tracking-tight text-slate-900 dark:text-white">
       {role === "patient" ? (
         <>Your Health, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-sky-700 dark:from-sky-300 dark:via-sky-100 dark:to-white drop-shadow-sm">Decoded by AI.</span></>
       ) : (
         <>Empowering <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-sky-700 dark:from-sky-300 dark:via-sky-100 dark:to-white drop-shadow-sm">Healthcare Providers.</span></>
       )}
      </h1>
