...
export default function RegisterPage() {
  ...
  try {
   ...
   toast.success(
    <div className="flex flex-col gap-1">
     <span className="font-heading font-bold text-foreground">Registration Successful</span>
     <span className="text-sm text-slate-600 dark:text-slate-300">Welcome to CareFlow! Loading your secure environment...</span>
    </div>,
    {
 ...
 return (
  <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col md:flex-row relative overflow-hidden font-sans">
   ...
   <div className="hidden md:flex w-full md:w-5/12 lg:w-1/2 relative flex-col justify-between p-12 lg:p-16 bg-slate-950 text-white overflow-hidden shadow-2xl z-10 transition-colors duration-1000">
    ...
    <div className="relative z-20">
     ...
     <div className="max-w-md mt-16 space-y-8">
      <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-[0_0_15px_rgba(56,189,248,0.15)]">
        ...
        <span className="text-xs font-bold uppercase tracking-widest text-sky-100">Join the Network</span>
      </div>
      <h1 className="text-5xl lg:text-6xl font-heading font-extrabold leading-[1.1] tracking-tight">
       {role === "patient" ? (
         <>Your Health, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-sky-100 to-white drop-shadow-sm">Decoded by AI.</span></>
       ) : (
         <>Empowering <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-sky-100 to-white drop-shadow-sm">Healthcare Providers.</span></>
       )}
      </h1>
