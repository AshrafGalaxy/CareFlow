        ...
        <div className="relative z-20">
          ...
          <div className="max-w-md mt-20 space-y-6">
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-sky-50/80 dark:bg-white/5 border border-sky-100 dark:border-white/10 backdrop-blur-md shadow-[0_0_15px_rgba(56,189,248,0.1)] dark:shadow-[0_0_15px_rgba(56,189,248,0.15)]">
              ...
              <span className="text-[11px] font-bold uppercase tracking-widest text-sky-700 dark:text-sky-100">Verified Personnel Only</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-heading font-extrabold leading-[1.15] tracking-tight text-slate-800 dark:text-white">
              Modern Care, <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 via-sky-600 to-emerald-500 dark:from-sky-300 dark:via-sky-100 dark:to-white drop-shadow-sm">Elevated.</span>
            </h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`relative w-full h-14 px-5 rounded-xl border text-foreground text-sm placeholder:text-muted-foreground outline-none transition-all duration-300 focus:ring-4 focus:ring-sky-500/20 focus:border-sky-500 shadow-sm ${errors.email ? "border-red-400 focus:border-red-500 focus:ring-red-500/20 bg-red-50/50 dark:bg-red-950/20" : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/50 hover:border-sky-300 dark:hover:border-sky-700"
                      }`}
                    {...register("email", {
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className={`relative w-full h-14 pl-5 pr-12 rounded-xl border text-foreground text-sm placeholder:text-muted-foreground outline-none transition-all duration-300 focus:ring-4 focus:ring-sky-500/20 focus:border-sky-500 shadow-sm ${errors.password ? "border-red-400 focus:border-red-500 focus:ring-red-500/20 bg-red-50/50 dark:bg-red-950/20" : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/50 hover:border-sky-300 dark:hover:border-sky-700"
                      }`}
