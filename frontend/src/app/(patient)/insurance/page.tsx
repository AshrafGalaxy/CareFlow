        ...
        <div className="space-y-6">
          ...
          {result.schemes_suggested?.map((scheme: any, i: number) => (
            <Card key={i} className="scheme-card">
              <p className="font-semibold text-slate-800">{scheme.name}</p>
          ...
          <Card className="scheme-card">
            <p className="font-semibold text-slate-800 mb-3">Estimated Cost Breakdown</p>
          ...
          <Card className="scheme-card">
            <p className="font-semibold text-slate-800 mb-3">Documents Checklist</p>
          ...
          <details className="border rounded-lg p-4">
            <summary className="cursor-pointer font-medium text-slate-800">Cashless Treatment Guidance</summary>
