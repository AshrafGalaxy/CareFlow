      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 bg-white">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center max-w-md mx-auto opacity-70">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">CareFlow AI is ready</h3>
        ...
        {messages.map((msg) => (
          ...
          >
            ...
            <div className={`px-5 py-4 rounded-3xl text-[15px] leading-relaxed shadow-sm ${msg.role === 'user' ? 'bg-blue-600 text-white rounded-br-sm ml-4' : 'bg-gray-50 border border-gray-100 text-gray-800 rounded-bl-sm'}`}>
