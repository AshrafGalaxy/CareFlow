...
export function ChatInput({ onSend, disabled }: ChatInputProps) {
 ...
 return (
  <div className="max-w-4xl mx-auto w-full">
   <div className="relative flex items-end bg-card border border-gray-300 rounded-2xl overflow-hidden shadow-sm focus-within:ring-4 focus-within:ring-blue-100/50 focus-within:border-blue-400 transition-all duration-200">
    <textarea
     ref={textareaRef}
     className="flex-1 max-h-40 min-h-[60px] w-full resize-none bg-transparent py-4 pl-5 pr-14 text-[15px] text-foreground placeholder-gray-400 focus:outline-none"
     value={value}
