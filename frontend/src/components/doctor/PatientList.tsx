...
export default function PatientList({ patients }: { patients: any[] }) {
 ...
 return (
  <Card className="rounded-2xl border-slate-200/60 dark:border-slate-800 shadow-sm bg-card /50 overflow-hidden flex flex-col h-[500px]">
   <div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 /80">
      ...
      {filtered.map((p) => (
       ...
       >
        <div className="flex items-center gap-4">
         ...
         <div>
          <p className="font-semibold text-foreground text-sm group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors">
           {p.name}
          </p>
        ...
        <div className="flex items-center gap-4">
         ...
         <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center group-hover:bg-sky-100 dark:group-hover:bg-sky-900/50 group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors">
