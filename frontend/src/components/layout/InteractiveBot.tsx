 ...
 return (
  ...
  >
   ...
   >
    ...
    <div 
     className={cn(
      "absolute bottom-full right-0 mb-4 w-56 bg-card text-slate-700 text-sm font-medium py-3 px-4 rounded-xl shadow-xl border border-slate-100 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none origin-bottom-right scale-95 group-hover:scale-100",
