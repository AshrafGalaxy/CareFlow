...
import {
 LayoutDashboard, FileText, MessageSquare, Pill, Shield, Clock, LogOut, Settings, User, Users, ChevronLeft, ChevronRight, CalendarDays
} from "lucide-react"
    ...
    <AnimatePresence>
     {!isCollapsed && (
      ...
      >
       ...
       <span className="text-xs font-semibold px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded ml-2">Doctor</span>
      </motion.span>
     )}
    </AnimatePresence>
   </div>
