  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hover Tooltip */}
        <div 
          className="absolute bottom-full right-1/2 translate-x-1/2 mb-4 w-48 bg-white text-slate-700 text-xs font-medium py-2 px-3 rounded-lg shadow-xl border border-slate-100 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none text-center"
